...
{
    public class TypeofcompaniesController : Controller
    {
        // GET: Typeofcompanies
        type_of_companies Service = new type_of_companies();
        // GET: LifeCycleStage
        [HttpGet]
        ...
        [HttpPost]
        public ActionResult Create(Type_of_companies obj)
        {
        ...
        [HttpPost]
        public ActionResult Update(Type_of_companies obj)
        {
