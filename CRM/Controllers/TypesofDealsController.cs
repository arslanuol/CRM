...
{
    public class TypesofDealsController : Controller
    {
        Types_ofDeal Service = new Types_ofDeal();
        // GET: TypesofDeals
        ...
        [HttpPost]
        public ActionResult Create(Type_of_deal obj)
        {
        ...
        [HttpPost]
        public ActionResult Update(Type_of_deal obj)
        {
        ...
        public ActionResult CreateTypeofDeals()
        {
            return View();
        }
    }
