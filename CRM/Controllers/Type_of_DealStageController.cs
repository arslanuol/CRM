...
{
    public class Type_of_DealStageController : Controller
    {
        Type_of_DealStage Service = new Type_of_DealStage();
        // GET: Type_of_DealStage
        ...
        [HttpPost]
        public ActionResult Create(Type_of_Deal_Stage obj)
        {
        ...
        [HttpPost]
        public ActionResult Update(Type_of_Deal_Stage obj)
        {
